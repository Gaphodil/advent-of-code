# at some point i should make a cleaner version, 
# but if the program is "complete" it may be too late

# relative mode paramter = itself + current relative base (init = 0)
# eg. 204, -1 = output 204
